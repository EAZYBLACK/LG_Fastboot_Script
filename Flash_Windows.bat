...
resources\platform-tools\fastboot.exe getvar current-slot 2>&1 | findstr /C:": a" >nul && set "suffix=_a"
resources\platform-tools\fastboot.exe getvar current-slot 2>&1 | findstr /C:": b" >nul && set "suffix=_b"
